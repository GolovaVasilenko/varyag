        ...
        <?php
            ...
            switch($content) {
                ...
                case 'coach-add':
                    ...
                    break;
                case 'abonement':
                    include_once PLUGIN_UNIT_PATH . "/templates/pages/abonement.php";
                    break;
                case 'abonement_add':
                    include_once PLUGIN_UNIT_PATH . "/templates/pages/abonement_add.php";
                    break;
                case 'abonement_edit':
                    include_once PLUGIN_UNIT_PATH . "/templates/pages/abonement_edit.php";
                    break;
                case 'list_students':
