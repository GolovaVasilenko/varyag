...
?>
    <main id="primary" class="site-main">
        ...
        <div class="top-block top-block--bread">
            <div class="top-block__video top-block__video--no-over">
                <video id="videomain" loop="" muted="" playsinline="" preload="metadata">
                    <source src="<?=get_template_directory_uri();?>/img/video-back.mp4#t=0.5">
                </video>
            </div>
            <div class="top-block__body container">
                <div class="top-block__middle">
                    ...
                    <div class="top-block__sub-title">
                        Тренерам с группами бесплатно. Более 20 видов спорта. Татами, 3 спортзала, волейбольная площадка,
                        футбольное поле, бассейн
                    </div>
                    <div class="top-block__buttons">
                        <a class="button button--big button--border js-open-form">
                ...
                <div class="top-block__bottom">
                    <div class="top-block__address">
                        <div class="address-block">
                            ...
                            <a target="_blank" href="https://yandex.ru/maps/org/uyut_tamani/1203498666/?ll=36.704659%2C45.124402&amp;z=15" class="address-block__body">
                                <span>Место проведение:</span>
                                <span>г. Тамань пос. Волна</span>
                            </a>
                        </div>
                    </div>
                </div>
